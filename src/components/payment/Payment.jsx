...
const stripeInstance = loadStripe('pk_test_51S13yBGUrztqgKfN2jIO6CH2UFbAFAwR3BY7CSwzhkDQWiv98rYy4hbym6x9mjjHkMdyteg889LBPZ4Qs1D08Yzl00qGaozFNJ')
...
const PaymentForm = ({ amount, orderId, onSuccess }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            // Step 1: Initialize payment. Generate transaction ID from backend
            const body = {
                amount: amount,
                orderId: orderId
            }
